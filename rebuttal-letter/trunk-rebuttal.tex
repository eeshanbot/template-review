...
If you need to put the line number directly in the text, you can use a custom macro \texttt{$\backslash$ref\{ prefix-tag \}}. 
...
\label{sec:test}
Notice that this uses the same macro, \texttt{$\backslash$lreviewer}, but leaves the second output blank.
